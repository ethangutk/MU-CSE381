...
public:
    ...
    /**
     * This is a helper method that sees if the URL can be connected to and
     * a CVS file can be gotten from that.
     * 
     * @param is Data from HTML File
     * @param host website host as a string
     * @param port port number as a string
     * @param path path as a string
     */
    void checkURLConnection(boost::asio::ip::tcp::iostream& is, 
        std::string host,
        std::string port, 
        std::string path);
