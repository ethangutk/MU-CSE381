...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk exercise07_part3

exercise07_part3: ${OBJECTFILES}
	${LINK.cc} -o exercise07_part3 ${OBJECTFILES} ${LDLIBSOPTIONS} -lboost_system -lpthread -lmysqlpp
